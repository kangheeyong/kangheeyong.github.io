...
###  문제 접근 과정
####  과거 문제 접근 방법
 ![achitecture1](/assets/project_1/1.JPG)
...
* ##### 하드웨어를 고려를 안함
 ...
 ![achitecture3](/assets/project_1/3.JPG)
...
* ##### 출력 및 입력 사이의 거리를 고려 안함
 ...
 ![achitecture4](/assets/project_1/4.JPG)
...
마이크와 스피커의 거리는 일정하지만, 스피커의 음량은 상황에 따라 다를 수 있다. 따라서 같은 ref신호를 사용해도 음량을 어떻게 하느냐에 따라서 다은 입력상황이 만들어 진다.  
 ...
 ![achitecture5](/assets/project_1/5.JPG)
...
* 결론 : 스피커를 모델링 해서 학습할때 임의로 스피커 특성이 반영된 음원파일을 입력데이터로 넣어보자.  
 ...
 ![achitecture6](/assets/project_1/6.JPG)
